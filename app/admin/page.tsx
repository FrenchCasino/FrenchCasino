            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                {partners.length === 0 ? (
                  ...
                  <div 
                    key={partner.id} 
                    className="glass-panel p-4 sm:p-5 rounded-2xl border border-slate-800 hover:border-gold/40 transition-all shadow-lg flex flex-col lg:flex-row lg:items-center justify-between gap-4 group"
                  >
                    {/* Colonne 1 : Nom du Partenaire & Statut */}
                    <div className="flex items-center gap-3.5 min-w-[240px]">
                      <div className="p-3 rounded-2xl bg-purple-950/60 border border-purple-800/50 text-gold shrink-0 group-hover:scale-105 transition-transform">
                        <Building className="w-6 h-6" />
                      </div>
                      <div>
                        <h4 className="font-bold text-white text-base leading-tight group-hover:text-gold transition-colors">
                          {partner.name}
                        </h4>
                        <div className="flex items-center gap-2 mt-1">
                          ...
                          <a 
                            ...
                            className="text-[11px] font-semibold text-purple-300 hover:text-white flex items-center gap-1 transition-colors"
                          >
                            <span>Lien Dashboard</span>
                    ...
                    {/* Colonne 2 : Badges Commissions (CPA & RS) */}
                    <div className="flex items-center gap-2.5 shrink-0">
                      <div className="bg-slate-900/90 border border-slate-800 px-3 py-2 rounded-xl text-left min-w-[120px]">
                    ...
                    <div className="flex-1 min-w-[200px] max-w-md">
                      <div className="text-[10px] text-slate-400 uppercase font-bold tracking-wider mb-1.5 flex items-center gap-1">
                        ...
                        Casinos Reliés Top Casino ({partner.casinos_relies?.length || 0})
                      </div>
                    ...
                    <div className="flex items-center gap-2 shrink-0 pt-2 lg:pt-0 border-t lg:border-t-0 border-slate-800">
                      <button 
                        ...
                        className="px-3.5 py-2 rounded-xl bg-slate-900 hover:bg-slate-800 border border-slate-700 text-xs font-semibold text-slate-200 hover:text-white flex items-center gap-1.5 transition-colors"
                      >
                      ...
                      <button 
                        ...
                        className="px-3.5 py-2 rounded-xl bg-red-950/40 hover:bg-red-900/60 border border-red-900/50 text-xs font-semibold text-red-400 hover:text-white flex items-center gap-1.5 transition-colors"
                      >
